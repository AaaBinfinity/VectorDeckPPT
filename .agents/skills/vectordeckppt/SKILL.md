...
4. Define one visual thesis and one shared design system before authoring slides. Translate the subject and audience into typography, spatial behavior, imagery, color, geometry, and pacing. Reject generic “modern professional” styling and any visual device that cannot explain its communication role.
